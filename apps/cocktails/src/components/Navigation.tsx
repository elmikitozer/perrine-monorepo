        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="container mx-auto px-4 py-6 flex flex-col gap-4">
              ...
              <button
                onClick={toggleLanguage}
                className="bg-safran/20 border border-safran/40 rounded-full px-4 py-3 text-noir hover:bg-safran/30 transition-colors flex items-center justify-center gap-2 mt-2"
              >
                <span className="font-bold">{locale.toUpperCase()}</span>

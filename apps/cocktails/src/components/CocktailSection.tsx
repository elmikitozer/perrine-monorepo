          ...
          >
            ...
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute right-24 md:right-10 lg:-right-6 xl:-right-2 -top-2 md:top-1 lg:-top-6"
              >
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.4 }}
                className="block absolute sm:right-[5rem] sm:-bottom-[2rem] md:right-[2rem] md:-bottom-6 xl:right-[-2.5rem] lg:block absolute lg:right-[-4rem] lg:-bottom-12 xl:right-[-2.5rem]"
              >
